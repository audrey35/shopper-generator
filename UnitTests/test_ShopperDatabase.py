...
class TestShopperDatabase(TestCase):
    ...
    def setUp(self):
        ...
        self.configuration = Configuration(start_date="2018-01-01", end_date="2019-12-31",
                                      ...
                                      mon_avg_traffic=800, tues_avg_traffic=1000, wed_avg_traffic=1200,
                                      ...
                                      weekend_avg_time_spent=60, sunny_weekend_avg_time_spent=10,
    ...
    def test_valid_creation(self):
        ...
        self.assertEqual(self.shopper_database.configuration, self.configuration, "Should be identical")
